...
import { getOrderListColumns } from '@app/containers/Orders/constants/order-list.columns'
import {
  ORDER_DETAIL_CREATE_ROUTE,
  ORDER_DETAIL_EDIT_ROUTE
} from '@app/containers/Orders/constants/order-routes.constants'
...
const OrderList = () => {
  ...
  const handleDelete = (order: Order) => {
    mutateDeleteOrders(
      ...
      {
        onSuccess: async () => {
          toast.success(`Delete order ${order.code} successfully`)
